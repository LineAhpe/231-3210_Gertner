...
static constexpr auto qt_meta_stringdata_ZN15ClientInterfaceE = QtMocHelpers::stringData(
    "ClientInterface"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15ClientInterfaceE[] = {
...
Q_CONSTINIT const QMetaObject ClientInterface::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15ClientInterfaceE.offsetsAndSizes,
    qt_meta_data_ZN15ClientInterfaceE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ClientInterfaceE_t,
        // Q_OBJECT / Q_GADGET
...
void *ClientInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15ClientInterfaceE.stringdata0))
